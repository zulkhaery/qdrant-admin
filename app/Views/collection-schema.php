...
$indexType = $isIndexed
    ? $payloadSchema[$field['field']]['data_type']
    : null;
...
<td class="action-cell">
    ...
    <div class="inline-form">
        ...
        <form method="POST"
              action="/collection-schema/create-index"
              class="inline-form">
        ...
        <?php if ($isIndexed): ?>
            ...
            <form method="POST"
                  action="/collection-schema/delete-index">
